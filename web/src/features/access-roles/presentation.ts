...
export const accessRolesCopy = {
  "zh-CN": {
    ...
    emptyDescription: "暂无说明", duplicateCode: "该标识已存在，请换一个。", requiredFields: "请填写名称和代码。",
  ...
  "en-US": {
    ...
    emptyDescription: "No description", duplicateCode: "This code already exists. Choose another code.", requiredFields: "Enter a name and code.",
